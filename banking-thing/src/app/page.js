  ...
  useEffect(() => {
    ...
    fetch(" https://bank-app-bankend.onrender.com/api/banking/user/getuser", {
      ...
      .then(data => {
        ...
        const trans = data.user.transactions;
        ...
        <div className="flex h-full max-h-screen flex-col gap-2">
          ...
          <div className="flex-1 overflow-auto py-2">
            <nav className="grid items-start px-4 text-sm font-medium">
              <Link
                className="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-900 bg-gray-100 transition-all dark:bg-gray-800 dark:text-gray-50"
                href="#"
              >
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                {Array.isArray(transactions) && transactions.length === 0 || !transactions ? (
                  <div className="text-gray-500 dark:text-gray-400">No recent transactions</div>
                ) : (
                  <div className="grid gap-4">
                    {transactions.map((transaction) => (
                      <div className="flex items-center justify-between" key={transaction.id}>
                        ...
                        <div className="text-green-500 font-medium">${transaction.amount}</div>
                      </div>
                    ))}
                  </div>
                )}
            ...
            <Card>
              ...
              <CardContent className="grid gap-4">
                <Link
                  className="flex items-center gap-2 rounded-md bg-gray-100 px-4 py-3 transition-colors hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700"
                  href="/transfers"
                >
                  <div className="bg-gray-200 rounded-md flex items-center justify-center aspect-square w-10 dark:bg-gray-700">
                    <MoveIcon className="h-5 w-5" />
                  </div>
                  <div>
                    <div className="font-medium">Transfer Funds</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">Send money to friends and family</div>
                  </div>
                </Link>
                <Link
                  className="flex items-center gap-2 rounded-md bg-gray-100 px-4 py-3 transition-colors hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700"
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500 dark:text-gray-400">Access your account statements</div>
                  </div>
                </Link>
              </CardContent>
            </Card>
